...
/* Considerando o que vc aprendeu sobre performance, resolva os exercicios abaixo 
   CONTANDO NÚMERO DE FUNCIONÁRIOS POR DEPARTAMENTO */
SELECT COUNT(*), departamento FROM funcionarios
GROUP BY departamento;

/* CONTANDO NÚMERO DE FUNCIONÁRIOS POR DEPARTAMENTO
   E ORDENANDO PELA COLUNA COUNT (1ª COLUNA)		*/
SELECT COUNT(*), departamento FROM funcionarios
GROUP BY departamento
ORDER BY 1;

/* 21 FILMES   --   53 ROUPAS
USANDO 'OR', COLOCAMOS COMO PRIMEIRA OPÇÃO A QUE TEM MAIOR QUANTIDADE
NESSE CASO É O DEPARTAMENTO 'ROUPAS'
...
/* CONTANDO NÚMERO DE FUNCIONÁRIOS POR SEXO */
SELECT COUNT(*), sexo FROM funcionarios
GROUP BY sexo;

/* 491 Feminino   --   484 Masculino 
CONTANDO O NÚMERO DE FUNCIONÁRIAS POR DEPARTAMENTO */
SELECT COUNT(*), departamento FROM funcionarios
GROUP BY departamento
ORDER BY 1;
